...
const Category = ({ onReset, data, subCategories }: IProps) => {
  ...
  return (
    <div className="flex flex-col border border-gray-200 mb-2 rounded-md odd:bg-gray-100">
      <div className="flex items-center justify-between p-2.5 pl-6 border-t border-gray-200">
        <span className="inline-block w-52 text-gray-800 text-lg">
          {categoryName}
        </span>
        <div>
      ...
      {subCategories !== undefined && subCategories?.length > 0 && (
        <div className="flex flex-col pt-2 border-t border-gray-300">
          {subCategories?.map((subCat) => (
            <div
              className="flex justify-between items-center mx-2 mb-2 ml-7"
              key={subCat.id}
            >
              <span className="inline-block w-52 text-gray-800 text-lg">
                {subCat.name}
      ...
      {showDelete && (
        <Popup
          width="300px"
          content={
            <div className="w-full p-5 pb-10 flex gap-4 flex-col items-center justify-center text-center">
